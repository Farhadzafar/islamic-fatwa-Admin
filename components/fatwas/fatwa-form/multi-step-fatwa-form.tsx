...
const API_BASE_URL =
  "https://final-year-backend-project.onrender.com/api/fatwa";
  ...
  const handleSubmit = async () => {
    ...
    if (isValid) {
      ...
      try {
        ...
        if (
          !globalSettings.question ||
          !globalSettings.category ||
          !globalSettings.scholar
        ) {
          setSubmitStatus({
            type: "error",
            message:
              "Please fill in all global settings (Question, Category, Scholar)",
          });
        ...
        console.log("❤️❤️❤️❤️👌", submissionData);
        ...
        setSubmitStatus({
          type: "error",
          message: `Failed to submit fatwa: ${
